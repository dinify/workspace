        ...
        <MuiThemeProvider theme={theme}>
          ...
          {!publised && (
            <Stepper
              ...
              connector={<StepConnector style={{ padding: '5px 0' }} />}
            >
              {sectionSteps.map(step => (
                <Step key={step.id}>
                  <StepLabel active={location.pathname === step.path}>
                    <div className={classes.stepLabel}>
                      <Link style={{ color: 'inherit' }} to={step.path}>
                        {t(step.id)}
                      </Link>
                    </div>
                  </StepLabel>
          ...
          >
            <div style={{ margin: '12px 0' }}>{restaurant.name}</div>
            {!!publised && (
              <Typography
                variant="caption"
                align="center"
