...
(function (root, factory) {
  ...
  var validateParameterTypeMessageVariables = function validateParameterTypeMessageVariables(value, name) {
    validateParameterType(value, name, value === undefined || isPlainObject(value) || Array.isArray(value), "Array or Plain Object");
  };

  var messageFormatterFn = function messageFormatterFn(formatter) {
  ...
  Globalize.messageFormatter = Globalize.prototype.messageFormatter = function ()
  /* path */
  {
