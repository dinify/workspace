...
(function (root, factory) {
  ...
  var validateParameterTypeCurrency = function validateParameterTypeCurrency(value, name) {
  ...
  var currencySupplementalOverride = function currencySupplementalOverride(currency, pattern, cldr) {
    var digits,
        fraction = "",
  ...
  var currencyUnitPatterns = function currencyUnitPatterns(cldr) {
  ...
  var currencyCodeProperties = function currencyCodeProperties(currency, cldr) {
  ...
  var currencyNameFormat = function currencyNameFormat(formattedNumber, pluralForm, properties) {
    var displayName,
        unitPattern,
  ...
  var currencyFormatterFn = function currencyFormatterFn(numberFormatter, pluralGenerator, properties) {
  ...
  var currencyNameProperties = function currencyNameProperties(currency, cldr) {
  ...
  var currencySymbolProperties = function currencySymbolProperties(currency, cldr, options) {
    var currencySpacing,
        pattern,
        symbol,
  ...
  var objectOmit = function objectOmit(object, keys) {
    var key,
        copy = {};
