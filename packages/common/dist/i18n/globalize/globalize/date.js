...
(function (root, factory) {
...
})(void 0, function (Cldr, Globalize) {
  ...
  var createErrorInvalidParameterValue = function createErrorInvalidParameterValue(name, value) {
  ...
  var dateExpandPatternNormalizePatternType = function dateExpandPatternNormalizePatternType(character) {
    return dateExpandPatternSimilarFieldsMap[character] || character;
  };

  var datePatternRe = /([a-z])\1*|'([^']|'')+'|''|./ig;

  var stringRepeat = function stringRepeat(str, count) {
    var i,
        result = "";
  ...
  var dateExpandPatternAugmentFormat = function dateExpandPatternAugmentFormat(requestedSkeleton, bestMatchFormat, decimalSeparator) {
  ...
  var dateExpandPatternCompareFormats = function dateExpandPatternCompareFormats(formatA, formatB) {
    var a,
        b,
        distance,
        lenA,
  ...
  var dateExpandPatternGetBestMatchPattern = function dateExpandPatternGetBestMatchPattern(cldr, askedSkeleton) {
  ...
  var dateExpandPattern = function dateExpandPattern(options, cldr) {
    var dateSkeleton,
        result,
        skeleton,
        timeSkeleton,
  ...
  var dateFirstDayOfWeek = function dateFirstDayOfWeek(cldr) {
  ...
  var dateGetTimeZoneName = function dateGetTimeZoneName(length, type, timeZone, cldr) {
    var metaZone, result;
  ...
  var dateTimezoneHourFormatH = function dateTimezoneHourFormatH(hourFormat) {
  ...
  var dateTimezoneHourFormatHm = function dateTimezoneHourFormatHm(hourFormat, hFormat) {
    return hourFormat.split(";").map(function (format) {
  ...
  var runtimeCacheDataBind = function runtimeCacheDataBind(key, data) {
    var fn = function fn() {
      return data;
    };
  ...
  var dateFormatProperties = function dateFormatProperties(pattern, cldr, timeZone) {
    var properties = {
      numberFormatters: {},
      pattern: pattern,
  ...
  var dateParseProperties = function dateParseProperties(cldr, timeZone) {
    var properties = {
  ...
  var objectFilter = function objectFilter(object, testRe) {
    var key,
        copy = {};
  ...
  var dateTokenizerProperties = function dateTokenizerProperties(pattern, cldr, timeZone) {
    var digitsReSource,
        properties = {
