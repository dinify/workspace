...
(function (root, factory) {
  ...
  var numberFormatterFn = function numberFormatterFn(properties, pluralGenerator) {
  ...
  var numberNumberingSystem = function numberNumberingSystem(cldr) {
  ...
  var numberCompact = function numberCompact(compactType, cldr) {
    var maxExponent = 0;
  ...
  var numberNumberingSystemDigitsMap = function numberNumberingSystemDigitsMap(cldr) {
    var aux,
  ...
  var numberPatternProperties = function numberPatternProperties(pattern) {
  ...
  var numberSymbol = function numberSymbol(name, cldr) {
  ...
  var numberSymbolMap = function numberSymbolMap(cldr) {
    var symbol,
        symbolMap = {};
  ...
  var numberRound = function numberRound(method) {
    ...
    return function (value, incrementOrExp) {
      ...
      if (_typeof(incrementOrExp) === "object" && incrementOrExp.exponent) {
  ...
  var numberFormatProperties = function numberFormatProperties(pattern, cldr, options) {
  ...
  var numberSymbolInvertedMap = function numberSymbolInvertedMap(cldr) {
    var symbol,
        symbolMap = {};
  ...
  var objectMap = function objectMap(object, fn) {
  ...
  var numberParseProperties = function numberParseProperties(pattern, cldr, options) {
    var aux,
        decimalSymbolRe,
        digitsRe,
        groupingSeparatorRe,
  ...
  var numberPattern = function numberPattern(style, cldr) {
