...
(function (root, factory) {
  ...
  MessageFormat = function () {
      ...
      function parse(input) {
        var options = arguments.length > 1 ? arguments[1] : {},
          ...
          description: "\"}\""
            ...
            peg$c10 = function peg$c10(argIdx, efmt) {
          var res = {
          ...
          return {
            ...
            peg$c19 = function peg$c19(op, pf) {
          return {
          ...
          description: "\":\""
            ...
            peg$c24 = function peg$c24(d) {
          return d;
        },
            peg$c25 = function peg$c25(k, mfp) {
          return {
            key: k,
            val: mfp
          };
          ...
          description: "\"\\\\u\""
            ...
            peg$c59 = function peg$c59(h1, h2, h3, h4) {
    ...
    MessageFormat.prototype.runtime = {
      ...
      number: function number(value, offset) {
      ...
      plural: function plural(value, offset, lcfunc, data, isOrdinal) {
      ...
      select: function select(value, data) {
        if ({}.hasOwnProperty.call(data, value)) return data[value]();
        return data.other();
      },
      ...
      toString: function toString() {
        var _stringify = function _stringify(o, level) {
          if (_typeof(o) != 'object') {
    ...
    MessageFormat.prototype.compile = function (messages, opt) {
      var r = {},
          lc0 = this.lc,
          compileMsg = function compileMsg(self, msg) {
        try {
          ...
          stringify = function stringify(r, level) {
        if (!level) level = 0;
  ...
  var createErrorPluralModulePresence = function createErrorPluralModulePresence() {
    return createError("E_MISSING_PLURAL_MODULE", "Plural module not loaded.");
  };

  var validateMessageBundle = function validateMessageBundle(cldr) {
  ...
  var validateMessagePresence = function validateMessagePresence(path, value) {
    path = path.join("/");
  ...
  var validateMessageType = function validateMessageType(path, value) {
    path = path.join("/");
  ...
  var messageFormatterRuntimeBind = function messageFormatterRuntimeBind(cldr, messageformatter) {
