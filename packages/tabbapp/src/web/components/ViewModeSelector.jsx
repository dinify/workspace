...
class ViewModeSelector extends React.Component {
  ...
  render() {
    ...
    let splitButton = this.props.splitAvailable ? (
      <ToggleButton
        className={
          this.props.selected === 2 ? classes.rightSelected : classes.right
        }
    ...
    return (
      <div
        className={
          this.props.selected === 1 ? classes.containerPaper : classes.container
        }
      >
        <ToggleButton
          className={
            this.props.selected === 0 ? classes.leftSelected : classes.left
          }
        ...
        <ToggleButton
          className={
            this.props.selected === 1
              ? this.props.splitAvailable
                ? classes.betweenSelected
                : classes.rightSelected
              : this.props.splitAvailable
                ? classes.between
                : classes.right
          }
