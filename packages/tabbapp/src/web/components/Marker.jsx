...
class Marker extends PureComponent {
  ...
  render() {
    const {size = 40, onClick, classes} = this.props;
    ...
    return (
      <svg height={size} viewBox='0 0 40 40'
        ...
        <circle cx="20" cy="16" r="16"/>
      	...
      	<path fill="#fff" d="M16.1,17.3l2.8-2.8l-6.2-6.2c-0.5-0.5-1.3-0.3-1.6,0.3c-0.7,1.5-0.4,3.3,0.8,4.6L16.1,17.3z M22.9,15.5
