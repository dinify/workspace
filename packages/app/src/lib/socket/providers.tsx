...
const ListenerComponent = (props: React.PropsWithChildren<any>) => {
  useListeners();
  return <>{props.children}</>;
};
export const SocketReduxProvider = (props: React.PropsWithChildren<SocketConfig>) => {
  return <SocketProvider {...props}>
    <ListenerComponent>
      {props.children}
    </ListenerComponent>
  </SocketProvider>
