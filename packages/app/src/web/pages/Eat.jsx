      ...
      <div>
        {checkedin && (
          <div>
            {multiparty && (
              <div
                className={`${classes.defaultBackgroundFill} ${
                  splitMenuOpen ? 'sticky' : ''
                }`}
                style={{
                  top: 0,
                  zIndex: 100,
                  ...
                  >
                    <ResponsiveContainer>
                      <div style={{ display: 'flex' }}>
                        <div
                          style={{ flex: 1, display: 'flex', marginTop: 16 }}
                        >
                          <Typography
                        ...
                        {userIsMe && seat.cart && (
                          <IconButton
                            onClick={() =>
                              this.setState({ editingCart: !editingCart })
                            }
                          >
                      ...
                      {seat.cart && (
                        <div
                          style={{
                            marginBottom: userIsMe && seat.cart ? 16 : 0,
                          }}
                        >
                      ...
                      <Divider
                        style={{
                          marginTop: userIsMe && seat.cart ? 0 : 16,
                          marginBottom: 16,
                        }}
                      />
                      ...
                      {seat.bill &&
                        FN.MapToList(seat.bill.orders).map(order =>
                      ...
                      {userIsMe && seat.bill && (
                        ...
                        >
                          ...
                          >
                            ...
                            <Typography>
                              <Price
                                price={{ amount: subtotalAmount, currency }}
                              />
                            </Typography>
                          </div>
                          <div
                          ...
                          >
                            ...
                            <Typography>
                              <Price
                                price={{ amount: gratitudeAmount, currency }}
                              />
                            </Typography>
                          </div>
                          <Slider
                            disabled={awaitingPaymentConfirmation}
                            value={gratitude}
                            min={0}
                            max={50}
                            step={1}
                            onChange={(event, val) =>
                              setGratitude({ percentage: val })
                            }
                          />
                      ...
                      {userIsMe && seat.bill && (
                        ...
                        >
                          <Fab
                            fullWidth
                            disabled={awaitingPaymentConfirmation || selecting}
            ...
            <ContextMenu open={splitMenuOpen} onClose={this.onCancelSplit}>
              ...
              {!splitLoading && (
                <Button
                  ...
                  onClick={() =>
                    splitBill({
                      orderItems: selectedBillItems.map(item => ({
                        id: item.id,
                      })),
                      withIds: selectedSeats
                        .filter(seat => seat.user_id !== loggedUserId)
